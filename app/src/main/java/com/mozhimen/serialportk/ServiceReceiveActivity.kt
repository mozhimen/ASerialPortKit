...
import com.mozhimen.serialportk.databinding.ActivityReceiveServiceBinding
...
class ServiceReceiveActivity : BaseActivityVB<ActivityReceiveServiceBinding>() {
    private lateinit var _servicePortServiceDelegate: LifecycleServiceDelegate<ServiceReceiveActivity>
