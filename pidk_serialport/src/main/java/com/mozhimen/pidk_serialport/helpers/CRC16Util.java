package com.mozhimen.pidk_serialport.helpers;
...
public class CRC16Util {
    ...
    public static int getCrc16ToInt(byte[] arr_buff) {
        int len = arr_buff.length;
        ...
        byte[] crcb = intToBytes(crc);
        return (crcb[0] & 0xFF00) >> 8 | (crcb[1] & 0x00FF) << 8;
    }
}
